...
const ContactSection = () => {
  return (
    <section className="bg-gray-100 py-10 max-w-6xl mx-auto w-full px-4">
      <div className="flex flex-col md:flex-row  justify-center gap-8">
        ...
        items-center "
        >
          <h2 className="text-3xl text-gray-800 font-bold mb-6">Контакти</h2>
        ...
        <div className="md:w-1/2 flex justify-center mt-8 md:mt-0">
          <div className="max-w-6xl mx-auto text-center w-full">
            <h2 className="text-3xl text-gray-800 font-bold mb-6">Ми на мапі</h2>
            <div
