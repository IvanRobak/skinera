        ...
        <section className='max-w-6xl pt-32 m-auto'>
                    ...
                    return (
                        <div key={item.id} className="flex items-center gap-6 py-6 border-t">
                            ...
                            <div className="w-20 h-20 flex-shrink-0 relative">
                                <Image src={item.image_url ?? ''} alt={item.name.en} fill className="object-contain" />
                            </div>
                            {/* Info */}
                            ...
                            <div>
                                ...
                                >
                                    {[...Array(10)].map((_, i) => (
                                        <option key={i + 1} value={i + 1}>{i + 1} шт.</option>
                                    ))}
                                </select>
                            </div>
                            {/* Total */}
                            <div className="font-bold text-lg min-w-[90px] text-right">{item.price * item.quantity} грн</div>
                            {/* Remove */}
                           <button
            ...
            <div>
                ...
                <div className='flex justify-between my-6'>
                    <Link href={'/'} className="max-w-64 bg-purple-500 text-white py-4 px-8 rounded-lg hover:bg-purple-600 transition duration-300 shadow-md">
                        Назад до магазину 
                    </Link>
                    <Link href={'#'} className=" bg-gray-200 text-gray-800 py-4 px-8 rounded-lg hover:bg-gray-300 transition duration-300 shadow-md">
                        Замовити
                    </Link>
                </div>
            </div>    
